...
# Install and use the recommended version (20)
nvm install 20
nvm use 20
...
**Note:** While any Node.js version 20.0.0+ is supported, using the version specified in `.nvmrc` (20) ensures maximum consistency across development environments.
